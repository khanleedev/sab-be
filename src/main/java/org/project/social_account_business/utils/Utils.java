...
public class Utils {
    ...
    private static AtomicInteger orderStt = new AtomicInteger(0);
    private static String currentDate = DateUtils.getFormatDateYyyyMmDd(new Date());
    ...
    public static String generateCode(String prefix, Date date) {
        val displayId = new StringBuilder();
        displayId.append(prefix);
        String formattedDate = DateUtils.getFormatDateTime(date);
